...
public class SettingSetupProcessorImpl {
	private static Logger logger = SahandLogger
			.getSahandLogger(SettingSetupProcessorImpl.class);
	...
	public SettingSetupResponse lookupFactory(SettingSetupRequest request,OperationType type) {
	...
	public List<SystemLookupInformation> loadLookup(SystemLookupInformation systemLookupInformation) throws Exception {
		
		List<SystemLookupInformation> systemLookupInformations = new ArrayList<SystemLookupInformation>();
		...
		{
			systemLookupInformations.add(lookupManagementImpl.convertFrom(systemLookupTable,systemLookupInformation));
		}
